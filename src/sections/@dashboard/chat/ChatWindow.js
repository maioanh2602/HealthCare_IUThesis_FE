...
export default function ChatWindow({ dataWebSocket, setDataWebSocket, page, hasMore, setPage, setHasMore }) {
  ...
  const handleSendMessage = (value) => {
    socket.emit('sendMessage', { roomID: value.conversationId, message: value.message, type: value.type });
